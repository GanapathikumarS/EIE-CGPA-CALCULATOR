...
async def help_command(update: Update, context: CallbackContext) -> None:
    keyboard = [
        [InlineKeyboardButton("Start CGPA Calculation", callback_data='start_cgpa')]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text('Press the button to start processing...', reply_markup=reply_markup)
...
async def button_handler(update: Update, context: CallbackContext) -> None:
    ...
    if data == 'start_cgpa':
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("Semester 5", callback_data='sem5')],
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
def grade_buttons(subject):
    keyboard = [
        ...
        [InlineKeyboardButton("Not taken", callback_data='o')]
    ]
...
async def calculate_cgpa(query, user_id, semester) -> None:
    ...
    if total_credits > 0:
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.message.reply_text('SELECT YOUR DEPARTMENT :', reply_markup=reply_markup)
    else:
...
async def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    if text.lower() == 'cgpa':
        ...
        await update.message.reply_text('Invalid command. Please type "cgpa" to start.')
